...
function lib.addRadialItem(items, parentMenuId)
    if lation_ui then return exports.lation_ui:addRadialItem(items, parentMenuId) end
...
function lib.removeRadialItem(id, parentMenuId)
    if lation_ui then return exports.lation_ui:removeRadialItem(id, parentMenuId) end
